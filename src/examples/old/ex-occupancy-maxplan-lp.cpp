...
int main(int argc, char **argv)
{
	...
	try
	{
		...
		//auto p_algo =  sdm::algo::makeHSVI<TStatePrescriptor, TActionPrescriptor>(oMDP, "", "maxplan_lp", "MaxInitializer", "MinInitialize", discount, error, horizon, trials, "Example-MaxPlan-OccupancyMDP");
		...
		auto lower_bound = std::make_shared<sdm::MaxPlanValueFunctionLP<TStatePrescriptor, TActionPrescriptor>>(oMDP, horizon, lb_init);
