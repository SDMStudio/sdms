...
int main(int argc, char **argv)
{
    ...
    // // Instanciate bounds
    // std::shared_ptr<sdm::ValueFunction> lower_bound = std::make_shared<sdm::HyperplanValueFunction>(horizon,init_lb,maxplan_backup,action_maxplan,freq_prunning, type_of_maxplan_prunning_);
