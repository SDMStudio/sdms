...
namespace sdm
{
    ...
    HISQLearning<TObservation, TAction>::HISQLearning(std::shared_ptr<GymInterface<TObservation, TAction>> &env,
    ...
    template <typename TObservation, typename TAction>
    void HISQLearning<TObservation, TAction>::initLogger()
    {
    ...
    template <typename TObservation, typename TAction>
    void HISQLearning<TObservation, TAction>::do_initialize()
    {
        this->initLogger();
    ...
    template <typename TObservation, typename TAction>
    void HISQLearning<TObservation, TAction>::do_solve()
    {
        this->global_step = 0;
    ...
    template <typename TObservation, typename TAction>
    void HISQLearning<TObservation, TAction>::do_test()
    {
    }

    template <typename TObservation, typename TAction>
    void HISQLearning<TObservation, TAction>::do_episode()
    {
        this->step = 0;
        this->episode += 1;
    ...
    template <typename TObservation, typename TAction>
    void HISQLearning<TObservation, TAction>::do_step()
    {
    ...
    template <typename TObservation, typename TAction>
    void HISQLearning<TObservation, TAction>::update_model()
    {
    ...
    template <typename TObservation, typename TAction>
    TAction HISQLearning<TObservation, TAction>::select_action(const TObservation &obs)
    {
        ...
        {
            return this->q_value_->getBestAction_his(obs, this->step);
        }
