...
namespace sdm
{
    ...
    public:
         ...
         * 
         */
        RSVI(std::shared_ptr<SolvableByHSVI> world, std::shared_ptr<ValueFunction> value_function, double error, number num_samples, double max_time, std::string name = "RandomSearchVI");
    ...
    using RandomSearchVI = RSVI;
    using RandomSearchValueIteration = RSVI;
}