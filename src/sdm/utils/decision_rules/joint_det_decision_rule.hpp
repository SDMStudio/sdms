...
namespace sdm
{
   ...
   */
    ...
    class JointDeterministicDecisionRule : public Joint<std::shared<DeterministicDecisionRule<TState, TAction>>>
    {
    public:
...
#include <sdm/utils/decision_rules/joint_det_decision_rule.tpp>