...
namespace sdm
{
    ...
    public:
        EpsGreedy(double eps_deb = 1.0, double eps_fin = 0.1, double deb_expl = 0.0, double fin_expl = 0.9) : eps_(eps_deb), eps_deb_(eps_deb), eps_fin_(eps_fin), deb_expl_(deb_expl), fin_expl_(fin_expl)
        {
