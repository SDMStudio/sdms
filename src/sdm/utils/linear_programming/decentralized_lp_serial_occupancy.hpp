...
namespace sdm
{
    class DecentralizedLPSerialOccupancy : public DecentralizedLP
    {
    public :

        DecentralizedLPSerialOccupancy();
        DecentralizedLPSerialOccupancy(const std::shared_ptr<SolvableByHSVI>&);
