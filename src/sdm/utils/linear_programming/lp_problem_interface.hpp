...
namespace sdm
{
    ...
    public : 
         ...
         */
        virtual Pair<std::shared_ptr<Action>,double> createLP(const std::shared_ptr<State> &occupancy_state, number t) = 0;
         ...
         * @param t 
         */
        virtual void createObjectiveFunction(const std::shared_ptr<State> &occupancy_state, IloNumVarArray &var, IloObjective &obj, number t) = 0;
