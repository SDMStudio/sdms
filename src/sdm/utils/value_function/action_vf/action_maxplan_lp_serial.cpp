...
namespace sdm
{
    ...
    ActionVFMaxplanLPSerial::ActionVFMaxplanLPSerial() {}
    ActionVFMaxplanLPSerial::ActionVFMaxplanLPSerial(const std::shared_ptr<SolvableByHSVI> &world) : ActionVFMaxplanLP(world) {}
