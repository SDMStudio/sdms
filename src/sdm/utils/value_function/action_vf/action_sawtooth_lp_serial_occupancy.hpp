...
namespace sdm
{
    class ActionVFSawtoothLPSerialOccupancy : public ActionVFSawtoothLP
    {
    public:
        ActionVFSawtoothLPSerialOccupancy();
        ActionVFSawtoothLPSerialOccupancy(const std::shared_ptr<SolvableByHSVI>& world,TypeOfResolution current_type_of_resolution, number bigM_value, TypeSawtoothLinearProgram type_sawtooth_resolution);
