...
namespace sdm
{
    ...
    MaxPlanValueFunction2<TVector, TAction, TValue>::MaxPlanValueFunction2() {}

    template <typename TVector, typename TAction, typename TValue>
    MaxPlanValueFunction2<TVector, TAction, TValue>::MaxPlanValueFunction2(std::shared_ptr<SolvableByHSVI<TVector, TAction>> problem, int horizon, std::shared_ptr<Initializer<TVector, TAction>> initializer)
    ...
    template <typename TVector, typename TAction, typename TValue>
    MaxPlanValueFunction2<TVector, TAction, TValue>::MaxPlanValueFunction2(std::shared_ptr<SolvableByHSVI<TVector, TAction>> problem, int horizon, TValue default_value) : MaxPlanValueFunction2(problem, horizon, std::make_shared<ValueInitializer<TVector, TAction>>(default_value))
    {
    }

    template <typename TVector, typename TAction, typename TValue>
    void MaxPlanValueFunction2<TVector, TAction, TValue>::initialize(TValue value, number t)
    {
        TVector new_v(value);
    ...
    template <typename TVector, typename TAction, typename TValue>
    void MaxPlanValueFunction2<TVector, TAction, TValue>::initialize()
    {
        this->initializer_->init(this);
    }

    template <typename TVector, typename TAction, typename TValue>
    std::pair<TValue, TVector> MaxPlanValueFunction2<TVector, TAction, TValue>::getMaxAt(const TVector &state, number t)
    {
    ...
    template <typename TVector, typename TAction, typename TValue>
    TValue MaxPlanValueFunction2<TVector, TAction, TValue>::getValueAt(const TVector &state, number t)
    {
        if (this->isInfiniteHorizon())
        {
    ...
    template <typename TVector, typename TAction, typename TValue>
    void MaxPlanValueFunction2<TVector, TAction, TValue>::updateValueAt(const TVector &state, number t)
    {
    ...
    template <typename TVector, typename TAction, typename TValue>
    std::vector<TVector> MaxPlanValueFunction2<TVector, TAction, TValue>::getSupport(number t)
    {
    ...
    template <typename TVector, typename TAction, typename TValue>
    void MaxPlanValueFunction2<TVector, TAction, TValue>::prune(number t)
    {
        this->bounded_prune(t);
    }

    template <typename TVector, typename TAction, typename TValue>
    void MaxPlanValueFunction2<TVector, TAction, TValue>::bounded_prune(number t)
    {
    ...
    template <typename TVector, typename TAction, typename TValue>
    number MaxPlanValueFunction2<TVector, TAction, TValue>::size()
    {
