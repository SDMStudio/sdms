...
namespace sdm
{
    ...
    Pair<std::shared_ptr<Action>, double> ActionSelectionSawtoothWCSP::getGreedyActionAndValue(const std::shared_ptr<ValueFunction>& vf, const std::shared_ptr<State>& state, number t)
    {
    ...
    Pair<std::shared_ptr<Action>,double>  ActionSelectionSawtoothWCSP::createWCSPProblem(const std::shared_ptr<ValueFunction>& vf , const std::shared_ptr<State>& state, number t)
    {
