...
namespace sdm
{
    ...
    public:
        ...
        Pair<std::shared_ptr<Action>, double> selectBestAction(const std::shared_ptr<ValueFunctionInterface> &value_function, const std::shared_ptr<OccupancyState> &state, const std::shared_ptr<Hyperplane> &next_hyperplane, const std::shared_ptr<HistoryInterface> &ihistory, number t);
        double evaluateAction(const std::shared_ptr<ValueFunctionInterface> &value_function, const std::shared_ptr<OccupancyState> &private_occupancy_state, const std::shared_ptr<Action> &action, const std::shared_ptr<Hyperplane> &next_hyperplane, number t);
