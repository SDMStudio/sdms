...
namespace sdm
{
    ...
    std::shared_ptr<Initializer> createInstanceTabPOMDPInit(std::shared_ptr<SolvableByHSVI> world) { return boost::bind(createInstanceAlgoInit<POMDPInitializer>,world, "tabular_hsvi", 0.001, 200000)(); }
