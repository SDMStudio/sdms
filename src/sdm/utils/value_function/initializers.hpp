...
namespace sdm
{
    ...
    std::shared_ptr<Initializer<TState, TAction>> createInstanceTabMDPInit() { return boost::bind(createInstanceAlgoInit<TState, TAction, MDPInitializer>, "tabular_hsvi", 0.01, 200000)(); }
    ...
    template <typename TState, typename TAction>
    std::shared_ptr<Initializer<TState, TAction>> createInstanceTabPOMDPInit() { return boost::bind(createInstanceAlgoInit<TState, TAction, POMDPInitializer>, "tabular_hsvi", 0.01, 200000)(); }
    ...
    protected:
        ...
        static inline map_type registry_ = {
            ...
            {"MdpValueIterationInitializer", &createInstanceMDPValueIterationInit<TState, TAction>},
