...
namespace sdm
{
    ...
    std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> DqnPhomdpBackup::constructBatch(std::vector<sars_transition> transitions)
    {
    ...
    torch::Tensor DqnPhomdpBackup::getQValues(torch::Tensor t_batch, torch::Tensor b_batch, torch::Tensor u_batch)
    {
    ...
    torch::Tensor DqnPhomdpBackup::getTargetQValues(torch::Tensor next_t_batch, torch::Tensor next_b_batch, torch::Tensor r_batch, torch::Tensor regular_t_batch)
    {
        // // Let PyTorch know that we don't need to keep track of the gradient in this context.
		// torch::NoGradGuard no_grad;
