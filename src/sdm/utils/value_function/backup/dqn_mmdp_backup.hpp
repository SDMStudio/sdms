...
namespace sdm
{
    ...
    protected:
        ...
        torch::Tensor getQValues(torch::Tensor t_batch, torch::Tensor x_batch, torch::Tensor u_batch);
        torch::Tensor getTargetQValues(torch::Tensor next_t_batch, torch::Tensor next_x_batch, torch::Tensor r_batch, torch::Tensor regular_t_batch);
    };
