...
// namespace sdm
// {
//     PointSetQValueFunction::PointSetQValueFunction(number horizon, std::shared_ptr<ValueInitializer> initializer,  const std::shared_ptr<BackupInterfaceForValueFunction> &backup, const std::shared_ptr<ActionVFInterface> &action_vf)
//         : ValueFunction(horizon,initializer, backup, action_vf), TabularQValueFunction(horizon,0,initializer)
//     {
//     }


//     PointSetQValueFunction::PointSetQValueFunction(number horizon, double default_value, const std::shared_ptr<BackupInterfaceForValueFunction> &backup, const std::shared_ptr<ActionVFInterface> &action_vf)
//         : PointSetQValueFunction(horizon,std::make_shared<ValueInitializer>(default_value),backup,action_vf)
//     {
//     }
