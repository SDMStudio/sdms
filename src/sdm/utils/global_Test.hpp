                                            ...
                                            for(const number &sawtooth_BigM: all_sawtooth_BigM)
                                            {
                                                for(const std::string &formalism : all_formalism)
                                                {
                                                    ...
                                                    for(int i =0; i<mean;i++)
                                                    {
                                                        ...
                                                        try
                                                        {
                                                            auto algo = sdm::algo::make("hsvi",filepath_,formalism,upper_bound,lower_bound,upper_bound_init,lower_bound_init,discount,0.01,horizon,1000,truncation,name,1000,sawtooth_current_type_of_resolution,sawtooth_BigM);
