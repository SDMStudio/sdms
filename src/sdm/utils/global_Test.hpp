...
namespace sdm
{
        ...
        std::string filepath = "../data/world/dpomdp/",std::string save_path = "../../run/Resultat/resultat.csv") 
    {
        ...
        myfile<<"Filename,Horizon,Discount,Upper_init,Lower_init,Upper_bound,Lower_bound,truncation,sawtooth_type_of_resolution, sawtooth_BigM,Problem,Resultat,Time,Trial \n";
                                            ...
                                            for(const number &sawtooth_BigM: all_sawtooth_BigM)
                                            {
                                                for(const std::string &formalism : all_formalism)
                                                {
                                                    ...
                                                    for(int i =0; i<mean;i++)
                                                    {
                                                        ...
                                                        try
                                                        {
                                                            auto algo = sdm::algo::make("hsvi",filepath_,formalism,upper_bound,lower_bound,upper_bound_init,lower_bound_init,discount,0.01,horizon,10000,truncation,name,sawtooth_current_type_of_resolution,sawtooth_BigM);
