...
namespace sdm
{
    namespace algo
    {
         ...
         */
        std::shared_ptr<Algorithm> make(std::string algo_name, std::string problem_path, std::string formalism, double discount = 0.99, double error = 0.001, int horizon = 0, int trials = 1000)
        {
