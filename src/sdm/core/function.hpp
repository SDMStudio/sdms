...
namespace sdm
{
    ...
    public :
        ...
        virtual double operator()(const std::shared_ptr<State> &ostate, const number &t) = 0;
    ...
    public :
        ...
        virtual double operator()(const Pair<std::shared_ptr<State>, std::shared_ptr<Action>> &ostate, const number &t) = 0;
