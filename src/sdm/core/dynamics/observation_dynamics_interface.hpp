...
namespace sdm
{
     ...
     * 
     * A model of observation dynamics is well defined if it implements this interface. The observation dynamics is required to define a POMDP (see file POMDP.hpp) and related problems.
