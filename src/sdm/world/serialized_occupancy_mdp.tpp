...
namespace sdm
{
    ...
    template <typename TState, typename TAction>
    TState SerializedOccupancyMDP<TState, TAction>::nextState(const TState &ostate, const TAction &indiv_dr, int, HSVI<TState, TAction> *) const
    {
        number ag_id = ostate.getCurrentAgentId();
    ...
    template <typename TState, typename TAction>
    double SerializedOccupancyMDP<TState, TAction>::getExpectedNextValue(ValueFunction<TState, TAction> *value_function, const TState &ostate, const TAction &oaction, int t) const
    {
    ...
    template <typename TState, typename TAction>
    double SerializedOccupancyMDP<TState, TAction>::getDiscount(int t) const
    {
