...
namespace sdm
{
    ...
    struct WorldType
    {
        ...
        template <bool is_belief_mdp = std::is_same<TState, BeliefState<number>>::value>
        static std::enable_if_t<is_belief_mdp, BeliefMDP<BeliefState<number>, number, number>>
        getWorldType();

        template <bool is_belief_graph_mdp = std::is_same<TState, BeliefStateGraph_p<number, number>>::value>
        static std::enable_if_t<is_belief_graph_mdp, BeliefMDP<BeliefStateGraph_p<number, number>, number, number>>
        getWorldType();
        ...
        template <bool is_solving_pomdp = std::is_any<TState, BeliefState<number>, BeliefStateGraph_p<number, number>>::value>
