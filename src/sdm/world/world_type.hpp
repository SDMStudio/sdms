...
namespace sdm
{
    ...
    struct WorldType
    {
        ...
        template <bool is_solving_decpomdp = std::is_any<TState, OccupancyState<number, JointHistoryTree_p<number>>, PrivateOccupancyState<>, SerializedOccupancyState<SerializedState, JointHistoryTree_p<number>>>::value>
