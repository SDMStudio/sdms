...
//     virtual std::shared_ptr<Space<TState>> getStateSpace() = 0;
//     virtual std::shared_ptr<Space<TAction>> getActionSpace() = 0;
//     virtual std::shared_ptr<Space<TObservation>> getObsSpace() = 0;

//     virtual std::shared_ptr<StateDynamics<TState, TAction>> getStateDynamics() = 0;
