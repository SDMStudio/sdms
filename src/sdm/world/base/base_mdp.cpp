...
namespace sdm
{
    ...
    std::set<std::shared_ptr<State>> BaseMDP::getAllStates(number t) const
    {
        return this->getStateSpace(t)->getAll();
    }

    std::set<std::shared_ptr<Action>> BaseMDP::getAllActions(number t) const
    {
        return this->getActionSpace(t)->getAll();
    }

    std::set<std::shared_ptr<State>> BaseMDP::getReachableStates(const std::shared_ptr<State> &state,
                                                                 const std::shared_ptr<Action> &action, number t) const
    {
    }
    ...
    std::shared_ptr<Space> BaseMDP::getActionSpace(number)
    {
        return this->action_space_;
    }

    std::shared_ptr<Space> BaseMDP::getStateSpace(number)
    {
