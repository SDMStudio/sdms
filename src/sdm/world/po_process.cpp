...
namespace sdm
{
    ...
    PartiallyObservableProcess::PartiallyObservableProcess(DiscreteSpace<number> state_space, MultiDiscreteSpace<number> obs_spaces) : StochasticProcess(state_space), obs_spaces_(obs_spaces)
    {
    }

    PartiallyObservableProcess::PartiallyObservableProcess(DiscreteSpace<number> state_space, MultiDiscreteSpace<number> obs_spaces, Vector start_distrib) : StochasticProcess(state_space, start_distrib), obs_spaces_(obs_spaces)
    {
    }

    MultiDiscreteSpace<number> PartiallyObservableProcess::getObsSpace() const
    {
