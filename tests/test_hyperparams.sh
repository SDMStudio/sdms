...
do 
    ...
    do
        ...
        SDMStudio solve -a QLearning -f oMDP -h $h -m ${memory[$i]} -e 0.1 --p_c 0.1 --p_o 0.01 --p_b 0.001 --lower_bound maxplan_wcsp --lb_init Min --time_max 14400 -t 1000000 -w "${worlds[$i]}.dpomdp" --name "qlearning_${worlds[$i]}_${h}_wcsp"
