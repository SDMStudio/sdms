...
do 
    ...
    do
        ...
        echo "Run PBVI, world=${worlds[$i]}, h=$h, please wait ..."
        SDMStudio solve -a PBVI -f oMDP -h $h -m ${memory[$i]} -e 0.01 --p_c 0.1 --p_o 0.01 --p_b 0.001 --lower_bound maxplan_wcsp --time_max 7200 --num_samples 100 -w "${worlds[$i]}.dpomdp" --name "pbvi1000_${worlds[$i]}_${h}_wcsp"
