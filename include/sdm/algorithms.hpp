...
namespace sdm
{
    namespace algo
    {
        ...
        std::shared_ptr<sdm::HSVI<TState, TAction>> makeMappedHSVI(std::shared_ptr<POSG> problem, double discount = 0.99, double error = 0.001, int horizon = 0, int trials = 10000)
        {
         ...
         */
        template <typename TState, typename TAction>
        auto make(std::string algo_name, std::shared_ptr<POSG> problem, double discount = 0.99, double error = 0.001, int horizon = 0, int trials = 10000)
        {
